...
R=->ray_orig,ray_dir,depth{
	...
	color+=(!sphere[4]||intersect[0].ceil%2==intersect[2].ceil%2?sphere[2]:sphere[4])*[0,normal%light_dir].max+V[1]*(normal%N[light_dir+N[V[0]-intersect]]).clamp(0,1)**50 if light_distances[WORLD.index(sphere)]==light_distances.min
